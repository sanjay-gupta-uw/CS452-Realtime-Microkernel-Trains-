...
The code can be found online at "", and has the following commit hash: "". The following sequence of steps compiles this source code into an elf image file -- note that the code has been written for the Arm Cortex A72.
