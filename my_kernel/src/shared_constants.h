...
#define CLOCK_LOCATION_Y +1

#define IDLE_LOCATION CLOCK_LOCATION_Y

#define VELOCITY_LOCATION_Y IDLE_LOCATION + 1

#define SWITCH_LOCATION VELOCITY_LOCATION_Y + 9
#define SWITCH_STATUS_COL BOX_WIDTH - 6

#define CMD_LOCATION SWITCH_LOCATION + 26
#define TRANSMITTED_BYTES_LOCATION CMD_LOCATION + 1
#define TRANSMITTED_BYTES_COL 1
...
#define TRACK_LAYOUT_LOCATION_Y SWITCH_LOCATION + 22 + 6
#define TRACK_LAYOUT_LOCATION_X 2

// defined in io.h
// #define DEBUG_COLUMN 150
